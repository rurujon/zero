package com.zd.back.tipboard.comment.controller;
...
import com.zd.back.tipboard.bbs.dto.response.CreateCommentResponse;
import com.zd.back.tipboard.comment.dto.request.CommentRequest;
import com.zd.back.tipboard.comment.dto.request.UpdateCommentRequest;
import com.zd.back.tipboard.comment.dto.response.CommentResponse;
import com.zd.back.tipboard.comment.dto.response.DeleteCommentResponse;
import com.zd.back.tipboard.comment.dto.response.UpdateCommentResponse;
import com.zd.back.tipboard.comment.service.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<UpdateCommentResponse> updateComment(@AuthenticationPrincipal UserDetails userDetails,
        @PathVariable Integer seq, @RequestBody UpdateCommentRequest req) {
